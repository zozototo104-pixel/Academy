...
function makeFallbackMcq(concept: string, specAr: string, caseBased = false, i = 0): GeneratedQuestion {
  ...
  const stems = caseBased
    ? [
        `بالاستناد إلى هذا الحدث/الفكرة من الكتاب: «${idea}»، ما القرار الأكثر اتساقاً مع إدارة مشاريع ناضجة داخل تخصص ${specAr}؟`,
        `إذا اعتبرنا الموقف الآتي من الكتاب حالة مشروع: «${idea}»، فما التصرف الإداري الأدق؟`,
