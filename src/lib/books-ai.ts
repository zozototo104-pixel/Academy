...
${knowledgePrompt ? `بنك المعرفة الأكاديمي المنظم للاستئناس فقط، وليس مصدراً مستقلاً للسؤال. استخدمه لفهم المحاور، لكن لا تنسخ عبارات مثل «محور معرفي» أو «دليل من المحتوى» داخل السؤال:\n${knowledgePrompt}\n` : ''}
