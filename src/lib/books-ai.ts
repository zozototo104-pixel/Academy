...
${knowledgePrompt ? `بنك المعرفة الأكاديمي المنظم من قراءة الكتب أو من توصيفها الأكاديمي عند غياب نص مباشر. اعتمد عليه مع المقاطع النصية أعلاه لفهم المفاهيم والحالات وبذور الأسئلة، لكن لا تنسخ عناوينه أو عباراته التقنية داخل نص السؤال؛ حوّل المعرفة إلى سؤال أكاديمي واضح ومسنود بدليل:\n${knowledgePrompt}\n` : ''}
