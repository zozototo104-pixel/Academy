...
- استخرج فهرساً معرفياً منظمًا يصلح لبناء أسئلة امتحان: الموضوعات، المفاهيم، النظريات، المصطلحات، النماذج، الحالات العملية، والأسئلة المحتملة.
- إذا كان الملف كبيراً أو ممسوحاً ضوئياً ولا تستطيع قراءة كل الصفحات، لخّص ما ظهر فعلاً ولا تقل "تعذر" إلا عند انعدام القراءة.
