...
استخرج كل عناصر المعرفة العميقة والمختلفة فعلاً التي تراها مهمة من محتوى الكتاب. لا تلتزم بعدد محدد؛ توقف عندما تنتهي الأفكار الجوهرية. الجودة أهم من العدد، ولا تضف عناصر متشابهة لإكمال رقم معين. كل عنصر يجب أن يحتوي:
