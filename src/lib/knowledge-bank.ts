...
const MAX_DIRECT_FILE_AI_BYTES = 900 * 1024
...
export async function rebuildKnowledgeForBook(bookId: string): Promise<KnowledgeBuildResult> {
  ...
  if (!ai?.length && sourceText.length >= 900) {
    ...
    // لا نفشل بناء بنك المعرفة بسبب PDF ممسوح/غير نصي أو تعذر Gemini.
    // نبني خريطة مهنية أولية من توصيف الكتاب والبرنامج، ونضع ملاحظة واضحة أنها ليست اقتباساً من النص الكامل.
