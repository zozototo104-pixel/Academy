...
أجب JSON فقط كمصفوفة عناصر معرفة عميقة ومختلفة فعلاً حسب ما يستحقه محتوى الكتاب، دون الالتزام بعدد محدد. لا تكرر الفكرة بصياغات متعددة ولا تكمل العدد بعناصر عامة. كل عنصر بهذا الشكل:
