...
export const useAppStore = create<AppState>((set) => ({
  ...
  navigate: (view) => set({ view, mobileMenuOpen: false, ...(view !== 'program-detail' ? { programDetailsId: null } : {}) }),
  openProgram: (id) => set({ activeProgramId: id, view: 'dashboard', mobileMenuOpen: false }),
  openProgramDetails: (id) => set({ programDetailsId: id, view: 'program-detail', mobileMenuOpen: false }),
