...
- إذا كانت الشهادة أو كشف العلامات ملتقطة من شاشة هاتف/عارض PDF لكنها تعرض اسم الطالب والجامعة/الدرجة بوضوح، فصنفها كدليل مؤهل مقبول مبدئياً مع طلب أصل/نسخة أوضح عند الحاجة، ولا ترفضها لمجرد أنها لقطة شاشة.
- طابق الاسم بمرونة بين العربية والإنجليزية؛ مثل «محمد/محمود/درويش/الهندي» يمكن أن تظهر في الوثيقة كـ Mohammed / M / D / Al Hindi أو صياغة لاتينية قريبة.
- الصورة الشخصية المقبولة هي صورة وجه واضحة؛ لا تجعل عدم وجود اسم مكتوب داخل الصورة سبباً لرفضها، بل اعتبر انتماءها للطالب غير متحقق فقط ويُربط بالهوية/الجواز.
