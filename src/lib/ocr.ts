...
- إذا كانت الصورة لقطة شاشة من Vercel أو موقع أو لوحة تحكم أو محادثة أو صفحة نظام، اجعل docTypeDetected="لقطة شاشة واجهة نظام" وreadable=false حتى لو ظهر فيها كلام مثل شهادة أو سيرة أو صورة شخصية، لأنها ليست المستند نفسه.
- إذا كان الظاهر جهازاً أو أداة إلكترونية أو منتجاً وليس وجه إنسان، اجعل docTypeDetected="صورة جهاز/منتج" وreadable=false.
