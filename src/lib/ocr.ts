...
- إذا كان الملف لا يثبت التصنيف المطلوب، قل ذلك في matchNote بوضوح ولا تحاول مجاملة التصنيف المعلن.
- إذا كان شعاراً أو صورة زخرفية/رمزية/دينية أو تصميم يحتوي نصاً فقط ولا يوجد مستند رسمي، اجعل readable=false، واجعل docTypeDetected يصفه مثل "تصميم/صورة رمزية" وليس "شهادة" أو "صورة شخصية".
- لا تصنف الملف كشهادة أو كشف درجات إلا إذا ظهرت مؤشرات رسمية فعلية داخل الملف مثل اسم جهة تعليمية، درجة/برنامج، اسم صاحب المستند، توقيع/ختم/تاريخ أو جدول درجات/معدل.
- لا تصنف الملف كهوية/جواز إلا إذا ظهرت مؤشرات وثيقة هوية فعلية مثل رقم وثيقة/جنسية/تاريخ ميلاد/صورة بطاقة أو جواز.
- لا تصنف الملف كسيرة ذاتية إلا إذا كان يحتوي بنية CV/Resume أو خبرات/مهارات/تعليم مكتوبة.
- إذا كانت صورة وجه إنسان واضحة فعلاً فقط، اجعل docTypeDetected="صورة شخصية" وreadable=true حتى لو لا يوجد نص. أما التصميمات أو الصور الرمزية أو النصوص الدينية فليست صورة شخصية.
- إذا ظهر في الشهادة أو كشف الدرجات معدل نهائي/GPA/نسبة/تقدير عام مثل «جيد» أو «جيد جداً» أو Excellent، فاكتبه حرفياً داخل extractedText كما هو ظاهر ولا تعيد صياغته.
- لا تخترع اسماً أو مؤهلاً أو مؤسسة أو معدلاً غير ظاهر. لا تعتبر عنوان خانة الرفع مثل «الشهادة وكشف العلامات» دليلاً على أن الصورة شهادة.
...
export const DOC_TYPE_AR: Record<string, string> = {
  ...
  CV: 'السيرة الذاتية',
  EXPERIENCE: 'إثبات خبرات عملية',
  TRANSCRIPT: 'كشف درجات منفصل',
  SERVICE_FILE: 'ملف داعم للخدمة',
  FLOW_DOC_1: 'مرفق الخدمة 1',
  FLOW_DOC_2: 'مرفق الخدمة 2',
  FLOW_DOC_3: 'مرفق الخدمة 3',
  FLOW_DOC_4: 'مرفق الخدمة 4',
  FLOW_DOC_5: 'مرفق الخدمة 5',
  FLOW_DOC_6: 'مرفق الخدمة 6',
  FLOW_DOC_7: 'مرفق الخدمة 7',
  FLOW_DOC_8: 'مرفق الخدمة 8',
}
