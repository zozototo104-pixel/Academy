...
function finalEvaluationFormulaFor(category: string): AcademicEvaluationItem[] {
  if (category === 'DOCTORATE') {
    return [
      { label: 'اختبارات/تقارير القراءات المتقدمة', weight: 8, description: 'تقييمات قصيرة قبل اختبار المرحلة لقياس الفهم المتدرج للمراجع.' },
      { label: 'اختبار مرحلة القراءات المتقدمة', weight: 12, description: 'اختبار فصلي/مرحلي يقيس التحليل النقدي للمراجع والنماذج.' },
      { label: 'اختبارات/حالات التطبيق والتحليل', weight: 8, description: 'تقييمات محدودة على الحالات والأدوات التطبيقية قبل اختبار المرحلة.' },
      { label: 'اختبار مرحلة التطبيق والتحليل', weight: 12, description: 'اختبار مرحلي يقيس التطبيق والتحليل واتخاذ القرار المهني.' },
  ...
  if (category === 'MASTERS') {
    return [
      { label: 'اختبارات الفصل الأول القصيرة', weight: 10, description: 'اختبارات قبلية/مرحلية محدودة على الكتب والوحدات الأولى.' },
      { label: 'امتحان الفصل الأول', weight: 15, description: 'امتحان فصلي رئيسي يقيس المفاهيم الأساسية والقراءات الأولى.' },
      { label: 'اختبارات الفصل الثاني القصيرة', weight: 10, description: 'اختبارات قبلية/مرحلية محدودة على التطبيق والحالات العملية.' },
      { label: 'امتحان الفصل الثاني', weight: 15, description: 'امتحان فصلي رئيسي يقيس التطبيق والتحليل والحالات العملية.' },
  ...
  return [
    { label: 'اختبارات قصيرة ومتابعة', weight: 20, description: 'اختبارات محدودة قبل التقييم النهائي لمتابعة الفهم والتقدم.' },
    { label: 'واجبات أو أنشطة تطبيقية', weight: 20, description: 'تكليفات قصيرة وحالات عملية مرتبطة بالمهارة.' },
    { label: 'الاختبار النهائي', weight: 60, description: 'قياس إتقان المهارة ومخرجات البرنامج.' },
  ]
}
    ...
    return [
      {
        ...
        exams: term1Exams,
        assignments: term1Assignments.length ? term1Assignments : ['رفع السيرة والشهادات والخبرات الداعمة.', 'تقديم ملخص مهني يوضح نطاق الخبرة ومجالات الممارسة.'],
      ...
      },
      {
        ...
        exams: term2Exams,
        assignments: term2Assignments.length ? term2Assignments : ['تحليل حالة مهنية قصيرة في مجال الاعتماد.'],
  ...
  return [
    {
      ...
      requiredBooks: term1Books,
      exams: term1Exams,
      assignments: term1Assignments.length ? term1Assignments : ['قراءات موجهة وتلخيص أهم المفاهيم.', 'نشاط قصير للتحقق من الفهم.'],
    ...
    },
    {
      ...
      requiredBooks: term2Books,
      exams: term2Exams,
      assignments: term2Assignments.length ? term2Assignments : ['تحليل حالة مهنية قصيرة.', 'تقديم مخرج تطبيقي قابل للمراجعة.'],
