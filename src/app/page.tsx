...
import { api, clearToken, getToken, saveToken, useAppStore } from '@/lib/store'
...
import { routeStateFromLocation } from '@/lib/app-routes'
      ...
      <div className="w-full max-w-xl text-center">
        <div className="aact-startup-logo mx-auto mb-12 flex h-48 w-48 items-center justify-center rounded-full sm:h-56 sm:w-56">
          <img
            ...
            fetchPriority="high"
            decoding="async"
            className="h-[250px] w-[250px] object-contain drop-shadow-[0_24px_45px_rgba(0,0,0,0.35)]"
          />
        </div>
    ...
    const applyBrowserRoute = () => {
      try {
        ...
        useAppStore.setState({
          view: next.view,
          mobileMenuOpen: false,
          programsFilter: next.programsFilter || null,
          programDetailsId: next.programDetailsId || null,
          activeProgramId: next.activeProgramId || null,
          activeUnitId: next.activeUnitId || null,
          activeExamId: next.activeExamId || null,
          activeExamKind: next.activeExamKind || 'unit',
