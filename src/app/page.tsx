...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const v = q.get('view')
    const validViews = ['home', 'programs', 'program-detail', 'apply', 'auth', 'dashboard', 'unit', 'exam', 'chat', 'agent', 'admin', 'supervisor', 'student-preview', 'agent-preview', 'verify', 'directory', 'contact']
