  ...
  try {
    ...
    return NextResponse.json({
      ...
      overview: {
        ...
        weakSupervisorReplies: weakSupervisorReplies.length,
        weakSupervisorReplyRate,
      ...
      recommendations: [
        ...
        weakSupervisorReplies.length > 0 ? 'راجع الردود الضعيفة للمشرف الذكي وحسّن تعليمات السياق أو بنك المعرفة المرتبط بها.' : null,
        responseTimes.averageSeconds != null && responseTimes.averageSeconds > 120 ? 'متوسط زمن رد المشرف الذكي مرتفع؛ راجع مزود النموذج أو حجم السياق المرسل.' : null,
        appealRate > 10 ? 'نسبة الاعتراضات مرتفعة؛ راجع عدالة التصحيح ومعايير الأسئلة ذات الاعتراضات.' : null,
