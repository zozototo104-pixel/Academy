...
const SYSTEM_KEYS = [
  ...
  'AACT_S3_ENDPOINT', 'AACT_S3_BUCKET', 'AACT_S3_REGION', 'AACT_STORAGE_PUBLIC_BASE_URL', 'AACT_S3_ACCESS_KEY_ID', 'AACT_S3_SECRET_ACCESS_KEY', 'AACT_ALLOW_LOCAL_UPLOADS',
...
const SECRET_KEYS = new Set([
  'SMTP_PASS', 'RESEND_API_KEY', 'AACT_S3_ACCESS_KEY_ID', 'AACT_S3_SECRET_ACCESS_KEY', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET', 'PAYPAL_SECRET',
