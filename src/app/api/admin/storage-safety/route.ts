  ...
  try {
    ...
    return NextResponse.json({
      ...
      samples: {
        ...
        externallyStoredAssignments: assignmentStorageRows.map((item) => ({
          id: item.id,
          fileName: item.fileName,
          size: item.size,
          storageProvider: item.fileStorageProvider,
          storageKey: item.fileStorageKey,
          fileUrl: item.fileUrl,
          submittedAt: item.submittedAt,
        })),
        externallyStoredDefenseRecordings: defenseRecordingRows.map((item) => ({
          id: item.id,
          recordingMime: item.recordingMime,
          recordingSize: item.recordingSize,
          storageProvider: item.recordingStorageProvider,
          storageKey: item.recordingStorageKey,
