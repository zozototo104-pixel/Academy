...
- ممنوع أن تبدأ الملخصات بعبارات قالبية مثل: «يحوّل هذا العنصر»، «يعرض هذا العنصر»، «الدليل المقروء»، «خلاصة محورية من النص»، أو «يدرس الطالب هذا المحور».
- ادمج الدليل داخل الشرح بأسلوب طبيعي، ولا تضع سطر دليل خام أو اقتباس OCR طويل.
