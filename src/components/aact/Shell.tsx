...
export function AcademyLogo({
  ...
  // الشعار الرسمي مضمّن كصورة شفافة داخل الكود حتى لا يظهر رمز الصورة المكسورة ولا خلفيات سوداء.
  const sources = [AACT_SEAL_DATA_URI, '/icon-512.png', '/icon-192.png', '/apple-touch-icon.png']
