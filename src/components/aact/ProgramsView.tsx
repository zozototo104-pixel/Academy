                  ...
                  <div className="mt-auto space-y-2 pt-4">
                    ...
                    {!p.enrolled && (
                      <p className="mt-2 text-center text-[10px] font-bold leading-relaxed text-slate-400">
                        {p.category === 'SERVICE' ? 'بيانات الطلب ← إرفاق ما يلزم ← دراسة الإدارة ← تحديد التسعير أو الموعد ← إشعار المتقدم' : 'بيانات كاملة ← رفع الوثائق ← الإقرار ← رسوم تقديم 30$ ← دراسة الإدارة ← بعد القبول سداد الرسوم الدراسية'}
                      </p>
                    )}
                  </div>
                </CardContent>
